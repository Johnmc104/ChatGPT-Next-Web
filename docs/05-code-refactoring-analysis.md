...
| 子任务 | 说明 | 状态 |
|--------|------|------|
| R-07a | `utils/chat.ts` stream/streamWithThink 类型化 | ✅ −25 any |
...
| 序号 | 重构项 | 预估影响 | 实际结果 |
|------|--------|---------|---------|
| 6 | **R-05** ui-lib 拆分 ✅ | 651→5 个文件 | 651→359 行，+ui-lib-modal(261)+ui-lib-toast(59) |
| 7 | **R-06** exporter 拆分 ✅ | 697→4 个文件 | 697→492 行，+exporter-image(237) |
| 8 | **R-09** mcp-market hooks ✅ | −200 行主组件 | 755→482 行(−273)，+mcp-market-hooks(324) |
| 9 | **R-10** mask ContextPrompts ✅ | −118 行 | 682→498 行(−184)，+context-prompts(198) |
